...
<div class="row btn-liens" >
    <a class="btn btn-general position" href="<?=$action?>">Retourner</a>
</div>
...
<form id="frm-message" class="form-horizontal"  action="">
    ...
    <div class="form-group">
        <label class="control-label col-sm-3" for="nom_emetteur">Destinataire :</label>
         <div class="col-sm-9">
             <input class="form-control" name="nom_emetteur" id="nom_emetteur" type="text" value="<?= $message->getNomDestinataire()?>" readonly>
        </div>
    </div>
