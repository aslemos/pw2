...
<form id="frm-message" class="form-horizontal"  action="">
    ...
    <div class="form-group">
        <label class="control-label col-sm-3" for="nom_emetteur">Réclamant :</label>
        <div class="col-sm-9">
    ...
    <div class="form-group">
        <label class="control-label col-sm-3" for="objet">Objet de la réclamation :</label>
         <div class="col-sm-9">
             <input class="form-control" name="objet" id="objet" type="text" value="<?= $message->getDescriptionObjet()?>" readonly>
        </div>
    </div>
