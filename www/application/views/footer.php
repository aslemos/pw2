...
<!-- Scripts -->
<script defer src="ui/js/jquery.min.js" type="text/javascript"></script>
<script defer src="ui/js/bootstrap.min.js" type="text/javascript"></script>
...
<script defer src="ui/js/gmap.js"></script>
<script defer src="ui/js/scripts.js" type="text/javascript"></script>
