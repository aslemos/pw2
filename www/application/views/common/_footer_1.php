        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12" id="col-coord">
                <div class="text-container">
                    <h4>
                        <a href="mailto:kharratiadh82@gmail.com">rentcars@gmail.com</a>|
                        <a href="tel:15143184728">(514) 318-4728</a>
                    </h4>
...
<!-- Scripts -->
<script defer src="<?= base_url(); ?>assets/js/jquery.min.js" type="text/javascript"></script>
