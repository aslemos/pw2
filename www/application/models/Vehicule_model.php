...
class Vehicule_model extends CI_Model {
    ...
    public function createVehicule($vehicule_photo) {
    ...
    public function getVehiculesByMarqueId($marque_id) {
    ...
    public function getVehiculesByTypeId($type_id) {
    ...
    public function getVehiculesByArrId($arr_id) {
    ...
    public function getVehiculesByUserId($user_id) {
